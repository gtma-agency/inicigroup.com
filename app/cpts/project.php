...
// Register Custom Taxonomy - Services for Projects
function project_service() {
	$labels = array(
		'name'                       => _x( 'Service', 'Taxonomy General Name', 'basis' ),
		'singular_name'              => _x( 'Service', 'Taxonomy Singular Name', 'basis' ),
		'menu_name'                  => __( 'Services', 'basis' ),
		'all_items'                  => __( 'All Services', 'basis' ),
		'parent_item'                => __( 'Parent Service', 'basis' ),
		'parent_item_colon'          => __( 'Parent Service:', 'basis' ),
		'new_item_name'              => __( 'New Service Name', 'basis' ),
		'add_new_item'               => __( 'Add New Service', 'basis' ),
		'edit_item'                  => __( 'Edit Service', 'basis' ),
		'update_item'                => __( 'Update Service', 'basis' ),
		'view_item'                  => __( 'View Service', 'basis' ),
		'separate_items_with_commas' => __( 'Separate services with commas', 'basis' ),
		'add_or_remove_items'        => __( 'Add or remove services', 'basis' ),
		'choose_from_most_used'      => __( 'Choose from the most used', 'basis' ),
		'popular_items'              => __( 'Hot Services', 'basis' ),
		'search_items'               => __( 'Search Services', 'basis' ),
		'not_found'                  => __( 'Not Found', 'basis' ),
		'no_terms'                   => __( 'No Services', 'basis' ),
		'items_list'                 => __( 'Services list', 'basis' ),
		'items_list_navigation'      => __( 'Services list navigation', 'basis' ),
	);
	$args = array(
		'labels'                     => $labels,
		'hierarchical'               => true,
...
add_action( 'init', 'project_service', 1 );
